...
public class BaseDataUpdate implements BaseEntity {
	...
	public String toString() {
		return "BaseDataUpdate [" + "this.dataupdateId=" + this.dataupdateId + ", " + "this.datastdId=" + this.datastdId
				+ ", " + "this.userCode=" + this.userCode + ", " + "this.institutionId=" + this.institutionId + ", "
				+ "this.checkCode=" + this.checkCode + ", " + "this.docId=" + this.docId + ", " + "this.dictId="
				+ this.dictId + ", " + "this.dataObject=" + this.dataObject + ", " + "this.isTransfer="
