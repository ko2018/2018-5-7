    ...
    for ask_parm in list_ask_queue:
        ...
        if ask_parm['s_type'] == STATICS_TTEST:
            ...
            if ask_parm['s_type_func'] == STATICS_ANOVA_ONE_WAY:
                from anova_test import AnovaOneWay_test
                result = AnovaOneWay_test.calc_python_spark(json_data, ask_parm['crowID'])
            elif ask_parm['s_type_func'] == STATICS_ANOVA_TWO_WAY:

                from test.anova import AnovaTwoWay_test
                result = AnovaTwoWay_test.calc_python_spark(json_data, ask_parm['crowID'])
