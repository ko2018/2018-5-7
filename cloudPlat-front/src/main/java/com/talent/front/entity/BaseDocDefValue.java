...
public class BaseDocDefValue implements BaseEntity {
	...
	public String toString() {
		return "BaseDocDefValue ["
		 		+ "this.docdefvalueId=" + this.docdefvalueId + ", "
		 		+ "this.dictId=" + this.dictId + ", "
		 		+ "this.docId=" + this.docId + ", "
		 		+ "this.docdefvalueValue=" + this.docdefvalueValue + ", "
		 		+ "this.docdefvalueValuenew=" + this.docdefvalueValuenew + ", "
		 		+ "this.docdefvalueNum=" + this.docdefvalueNum + ", "
