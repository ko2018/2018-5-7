...
public class BaseInstitutionSnl implements BaseEntity {
    ...
    /**
     * 设置机构标准术语ID
     * @param institutionSnlId  机构标准术语ID
     */
	...
	public String toString() {
		return "BaseInstitutionSnl ["
		 		+ "this.institutionSnlId=" + this.institutionSnlId + ", "
		 		+ "this.dictId=" + this.dictId + ", "
		 		+ "this.docCname=" + this.docCname + ", "
		 		+ "this.docCvalue=" + this.docCvalue + ", "
		 		+ "this.institutionSnlVersionId=" + this.institutionSnlVersionId + ", "
		 		+ "this.snlCode=" + this.snlCode + ", "
		 		+ "this.snlName=" + this.snlName + ", "
		 		+ "this.snlNameUs=" + this.snlNameUs + ", "
