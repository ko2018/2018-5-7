...
import com.talent.front.dao.BaseDocValueFileDao;
...
public class BaseDocValueFileServiceImpl extends BaseServiceImpl<BaseDocValueFile> implements BaseDocValueFileService {
	...
	@CacheSpeObject(value = "baseDocValueFile", key = "#valuefileId")
	@Override
	...
	@CacheSpeObject(value = "baseDocValueFile", key = "#baseDocValueFile.valuefileId", OPER = CacheSpeObject.OPER.UPDATE)
	@Override
