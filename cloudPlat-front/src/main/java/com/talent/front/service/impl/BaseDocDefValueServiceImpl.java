...
import com.talent.front.dao.BaseDocDefValueDao;
...
public class BaseDocDefValueServiceImpl extends BaseServiceImpl<BaseDocDefValue> implements BaseDocDefValueService {
	...
	@CacheSpeObject(value = "baseDocDefValue", key = "#docdefvalueId")
	@Override
	...
	@CacheSpeObject(value = "baseDocDefValue", key = "#baseDocDefValue.docdefvalueId", OPER = CacheSpeObject.OPER.UPDATE)
	@Override
	...
	public PageResult<BaseDocDefValueDto> pageListDto(PageObject pageObject) {
		...
		if (totalCount > 0) {
			List<BaseDocDefValueDto> baseDocDefValueDtoList = ((BaseDocDefValueServiceImpl) AopContext
