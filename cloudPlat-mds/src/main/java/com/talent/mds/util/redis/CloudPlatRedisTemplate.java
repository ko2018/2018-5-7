package com.talent.mds.util.redis;
 ...
 * 自定义redisTemplate
 * 
 * @ClassName: CloudPlatRedisTemplate
 * @author fwp
 * @date 2017年7月24日 下午7:09:49
 */
@Component
public class CloudPlatRedisTemplate {
	private static final Logger logger = LoggerFactory.getLogger(CloudPlatRedisTemplate.class);
