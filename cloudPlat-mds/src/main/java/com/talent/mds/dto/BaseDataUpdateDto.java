...
public class BaseDataUpdateDto extends BaseDataUpdate {
    ...
    public String toString() {
        return "BaseDataUpdate [" + "this.dataupdateId=" + this.getDataupdateId() + ", " + "this.datastdId="
                + this.getDatastdId() + ", " + "this.userCode=" + this.getUserCode() + ", " + "this.institutionId="
                + this.getInstitutionId() + ", " + "this.checkCode=" + this.getCheckCode() + ", " + "this.docId="
                + this.getDocId() + ", " + "this.dictId=" + this.getDictId() + ", " + "this.dataObject="
